...
const tweenBeatIn = new TWEEN.Tween(tweenBeatCoords).to({ x: 0, y: 0, z: -30 }, 80).easing(TWEEN.Easing.Quadratic.Out);
const tweenBeatOut = new TWEEN.Tween(tweenBeatCoords).to({ x: 0, y: 0, z: 0 }, 200).easing(TWEEN.Easing.Quadratic.Out);
...
const tweenAnimOut = new TWEEN.Tween(tweenAnimCoords).to({ x: 0, y: 0, z: 0 }, 1000).easing(TWEEN.Easing.Quadratic.Out);
...
function initLogoText(alertTextP, posY, posX2 = 0, posZ = 0) {
    ...
    for (var j = 0; j < alertText.length; j++) {
        ...
        if (alertText.charAt(j) === 'A') {
            divisionWidth = 190;
        }
        if (alertText.charAt(j) === 'B') {
            divisionWidth = 170;
        }
        if (alertText.charAt(j) === 'C') {
            divisionWidth = 190;
        }
        if (alertText.charAt(j) === 'E') {
            divisionWidth = 190;
        }
        if (alertText.charAt(j) === 'H') {
            divisionWidth = 190;
        }
        if (alertText.charAt(j) === 'I') {
            divisionWidth = 130;
        }
        if (alertText.charAt(j) === 'L') {
            divisionWidth = 170;
        }
        if (alertText.charAt(j) === 'M') {
            divisionWidth = 190;
        }
        if (alertText.charAt(j) === 'S') {
            divisionWidth = 190;
        }
        if (alertText.charAt(j) === 'T') {
            divisionWidth = 190;
        }
        if (alertText.charAt(j) === 'V') {
            divisionWidth = 190;
        }
        if (alertText.charAt(j) === 'W') {
            divisionWidth = 230;
        }
        if (alertText.charAt(j) === '/') {
            divisionWidth = 160;
        }
        if (alertText.charAt(j) === '.') {
            divisionWidth = 110;
        }
        if (alertText.charAt(j) === '1') {
            divisionWidth = 130;
        }
